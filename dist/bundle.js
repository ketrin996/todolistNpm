...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _api_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/api */ \"./api/api.js\");\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ \"./client/dom.js\");\n\n\nconst container = document.getElementById('container');\n\nconst deleteDashboardData = (node, id) => _api_api__WEBPACK_IMPORTED_MODULE_0__[\"default\"].deleteBoard(id).then(() => node.remove()).catch(e => console.error(e));\n\nconst addDashboard = container => _api_api__WEBPACK_IMPORTED_MODULE_0__[\"default\"].addBoard().then(res => {\n  const dashboardId = res.data.id;\n  _dom__WEBPACK_IMPORTED_MODULE_1__[\"default\"].renderBoard(container, {\n    id: dashboardId,\n    title: 'New title',\n    todos: []\n  });\n});\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  deleteDashboardData,\n  addDashboard\n});\n\n//# sourceURL=webpack:///./client/dashboard-controll.js?");
